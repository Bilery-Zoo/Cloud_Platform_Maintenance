...
def new_whitelistip_append(old_whitelistip, new_whitelistip, comment, key, region=None, is_region_distinguish=False, ):
    """
    ...
    alibabacloud_switch = functions.AlibabaCloud(key, region)
